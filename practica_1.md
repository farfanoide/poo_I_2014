...
1. Abrir el ambiente haciendo click en el el archivo `.image` que se encuentra
...
2. Extienda la definición del robot agregando los mensajes: `#northEast`,
...
2. Preste atención, en cada caso, a la forma en que el robot interactúa con los
objetos a los que conoce. ¿Qué mensajes envía en esa interacción?

3. ¿Cual es el protocolo (cara visible) de la batería del robot?
